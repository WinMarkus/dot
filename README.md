...
- image artifacts are generated via OpenRouter image models (default Gemini 2.5 Flash Image) and render as real images in the bubble, with a breathing placeholder while painting and a retry control on failure
...
- env vars:
  ...
  - `OPENROUTER_IMAGE_MODEL` optional, default is `google/gemini-2.5-flash-image`
