...
- action sub-dots currently support inspect, prompt, regenerate, fork, and delete
- regenerate reruns the artifact from its existing prompt while keeping its position
...
- edit mode also exposes regenerate if the current result is not useful
